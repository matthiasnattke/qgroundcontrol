...
const char* MainWindow::_swarmControlWidgetName = "SWARM_CONTROL";
...
void MainWindow::_loadCurrentViewState(void)
{
    ...
    switch (_currentView) {
        ...
        case VIEW_ENGINEER:
            ...
            defaultWidgets = "MAVLINK_INSPECTOR_DOCKWIDGET,PARAMETER_INTERFACE_DOCKWIDGET";
            break;
        ...
        case VIEW_MISSION:
            ...
            defaultWidgets = "UNMANNED_SYSTEM_LIST_DOCKWIDGET,WAYPOINT_LIST_DOCKWIDGET,SWARM_CONTROL";
            break;
